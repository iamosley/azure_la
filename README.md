...
[^fn4]: Note that Azure CLI should only be used for administrative tasks. Early on during EDA, I used the CLI psql utility and the CLI would timeout due to 'inactivity' and I would lose my psql session. Sad.
